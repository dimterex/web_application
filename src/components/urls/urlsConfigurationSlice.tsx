...
import { addNewUrl, getUrls, removeUrls, setUrls } from "../../api/configuration/urlsApi";
...
export const urlsConfigurationSlice = createSlice({
    ...
    extraReducers: (builder) => {
      ...
      .addCase(getUrlsAsync.fulfilled, (state, action) => {
        ...
        state.urls = action.payload.map(model => ({ id: model.id, name: model.name, value: model.value }));
      })
